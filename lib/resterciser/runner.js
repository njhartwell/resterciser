...
/**
 * Loads and registers processors. Currently only
 * knows about its own processors, but should be
 * improved to allow passing in extra ones.
 *
 * @param Environment env
 */
function registerProcessors(env) {
	env.registerProcessor(require('./processor/grab_header'));
}
...
function setupEnv(options) {
	...
	// Registers processors to handle before/after things
	registerProcessors(env);
